    ...
    match msg {
        WM_COMMAND => {
            ...
            match id {
                ...
                ID_MODE_LIVE | ID_MODE_HOLD | ID_MODE_TOGGLE => unsafe {
...
impl SettingsWindow {
    ...
    unsafe fn build(&mut self, form: &SettingsForm, stale: &[String]) -> Result<i32> {
        ...
        unsafe {
            ...
            y += 20;
            // Toggle shares the trigger key with Hold key and differs only in latching.
            let live = child(
                page,
                w!("BUTTON"),
                "Live",
            ...
            // Live, Hold key, and Toggle buttons into the combos.
    ...
    pub fn read(&self, template: &SettingsForm) -> SettingsForm {
        ...
        unsafe {
            ...
            SettingsForm {
                mode: if checked(ID_MODE_TOGGLE) {
