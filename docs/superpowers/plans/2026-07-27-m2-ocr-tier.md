...
`src/lib.rs` currently reads `pub mod lookup;`. Make it:
...
Create `src/text/layout.rs` containing only this test module:
...
Add to `src/lib.rs`, keeping alphabetical order:
